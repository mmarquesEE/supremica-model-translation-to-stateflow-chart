  ...
  nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"machine")) {
      ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3955955189U);
      ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2324187611U);
      ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2573604634U);
      ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(71539568U);
    ...
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2580973457U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3629028379U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(472899270U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1365473030U);
  }
  ...
  int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(instanceChksum, "sXPevg5JXNqKWYyC9HR8XME") == 0) {
  ...
  nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(tpChksum, "sXPevg5JXNqKWYyC9HR8XME") == 0) {
...
unsigned int sf_model_get_post_codegen_info( int nlhs, mxArray * plhs[], int
  nrhs, const mxArray * prhs[] )
{
  char commandName[64];
  char tpChksum[64];
     ...
     case 1:
      {
        if (strcmp(tpChksum, "sXPevg5JXNqKWYyC9HR8XME") == 0) {
          ...
          const char* encoded_post_codegen_info =
            sf_c1_model_get_post_codegen_info();
